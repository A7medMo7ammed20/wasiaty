...
export class CommercialRealEstateMockApi
{
    private _tangables: any[] = CommercialRealEstate;
    ...
    registerHandlers(): void
    {
        ...
        .onGet('api/wealth-managements/commercial-real-estate/all')
        .reply(() =>
        {
            // Clone the Tangibles
        ...
        this._fuseMockApiService
        .onGet('api/wealth-managements/commercial-real-estate/tangible-types')
        .reply(() =>
        {
            // Clone the Tangibles
