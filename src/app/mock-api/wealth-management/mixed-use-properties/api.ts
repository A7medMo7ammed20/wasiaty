...
import { tangableWealth as tangableData  , tangableWealthType} from 'app/mock-api/wealth-management/mixed-use-properties/data';
import { TangibleWealthes } from 'app/modules/assets-management/wealth-management.types';
@Injectable({providedIn: 'root'})
export class MixedUsePropertiesMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        .onGet('api/wealth-managements/mixed-use-properties/all')
        .reply(() =>
        {
            // Clone the Tangibles
        ...
        this._fuseMockApiService
        .onGet('api/wealth-managements/mixed-use-properties/tangible-types')
        .reply(() =>
        {
            // Clone the Tangibles
