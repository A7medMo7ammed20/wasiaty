 ...
 *  'me'. If it belongs to the user we are Evaluationting with, then it
 *  left empty. We will be using this same conversation for each Evaluation
...
export const contacts = [
    {
        ...
        about: "Hi there! I'm using FuseEvaluation.",
        details: {
            emails: [
                {
