...
export class AssetsDashboardComponent implements OnInit, OnDestroy
{
    
    selectedProject: string = 'Assets';
     ...
     */
    constructor(
        private _AssetsDashboardService: AssetsDashboardService,
    ...
    ngOnInit(): void
    {
           ...
           // Get the data
           this._AssetsDashboardService.data$
