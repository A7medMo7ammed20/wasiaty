...
@Component({
    selector: 'bequest-detail',
    templateUrl: './create-bequest.component.html',
...
export class CreateBequestsComponent implements OnInit, OnDestroy {
    currentStep = 0;
