...
export class InsurancesComponent {
    ...
    ngOnInit(): void {
        this.individual$ = this._insurancesService.individuals$;
        this._insurancesService.individuals$;
        this.step$ = this._insurancesService.step$;
        this._insurancesService.step$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((steps: Steps) => {
                // Update the counts
                this.stepsCount = steps.steps.length;
    ...
    createInsurances(): void {
        // Create the task
        // this._insurancesService.createSteps().subscribe((step) => {
        // Go to the new task
